...
attendance_file = "ATTENDANCE_LOGBOOK_BACKUP.xlsx"  # Local backup only
THRESHOLD = 0.35
...
print("[ONYX] Initializing InsightFace model...")
...
def draw_header_hud(frame):
    ...
    cv2.putText(frame, ">> ONYX RECOGNITION SYSTEM <<", (20, 35), 
...
while True:
    ...
    if frame_count % recognition_interval == 0:
        ...
        for face in faces:
            ...
            similarities = [np.dot(emb, known_emb) for known_emb in known_embeddings]
    ...
    cv2.imshow("ONYX - CIA Tactical Interface", frame)
